...
export default function DisposisiBidangPage() {
  ...
  const fetchDisposisi = useCallback(async () => {
    try {
      ...
      setError(err.message || 'Gagal memuat data disposisi bidang');
    } finally {
      setLoading(false);
    }
  }, [page]);
  ...
  return (
    <div>
      <div className="mb-6">
        <h1 className="text-ds-h1">Disposisi Bidang</h1>
        <p className="text-sm mt-1" style={{ color: '#475569' }}>
          Menampilkan disposisi terkait bidang {user?.bidang || '-'}
        </p>
      </div>
      ...
      <div className="card">
        {loading ? (
          ...
          <EmptyState
            ...
            title="Belum Ada Disposisi Bidang"
            description="Belum ada disposisi yang berkaitan dengan bidang Anda."
          />
        ) : (
          <>
